...
from config.settings import (
    ...
    SUPPLY_DEMAND_RETEST_BASE_MIN_SCORE,
    EXTREME_SWEEP_RECLAIM_BASE_MIN_SCORE,
    MTF_SR_FVG_RECLAIM_BASE_MIN_SCORE,
    ORB_V00_BASE_MIN_SCORE,
    IFVG_RETEST_CONFLUENCE_BASE_MIN_SCORE,
    RANGE_SWEEP_RECLAIM_BASE_MIN_SCORE,
    VWAP_RANGE_MEAN_REVERSION_BASE_MIN_SCORE,
    WAVETREND_MOMENTUM_BASE_MIN_SCORE,
    MICRO_SR_SWEEP_RECLAIM_BASE_MIN_SCORE,
)
...
BASE_THRESHOLDS = {
    ...
    "SUPPLY_DEMAND_RETEST": SUPPLY_DEMAND_RETEST_BASE_MIN_SCORE,
    "EXTREME_SWEEP_RECLAIM": EXTREME_SWEEP_RECLAIM_BASE_MIN_SCORE,
    "MTF_SR_FVG_RECLAIM": MTF_SR_FVG_RECLAIM_BASE_MIN_SCORE,
    "ORB_V00": ORB_V00_BASE_MIN_SCORE,
    "IFVG_RETEST_CONFLUENCE": IFVG_RETEST_CONFLUENCE_BASE_MIN_SCORE,
    "RANGE_SWEEP_RECLAIM": RANGE_SWEEP_RECLAIM_BASE_MIN_SCORE,
    "VWAP_RANGE_MEAN_REVERSION": VWAP_RANGE_MEAN_REVERSION_BASE_MIN_SCORE,
    "WAVETREND_MOMENTUM": WAVETREND_MOMENTUM_BASE_MIN_SCORE,
    "MICRO_SR_SWEEP_RECLAIM": MICRO_SR_SWEEP_RECLAIM_BASE_MIN_SCORE,
}
