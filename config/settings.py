...
# =========================
# Confluence Family Counting
# =========================
ENABLE_CONFLUENCE_FAMILY_COUNTING = True

CONFLUENCE_FAMILY_MAP = {
    "ORB": "ORB_FAMILY",
    "ORB_V00": "ORB_FAMILY",
    "SESSION_ORB_RETEST": "ORB_FAMILY",

    "FLAG": "FLAG_FAMILY",
    "FLAG_REFINED": "FLAG_FAMILY",
    "TRIANGLE_PENNANT": "PATTERN_FAMILY",
    "HEAD_SHOULDERS": "PATTERN_FAMILY",

    "FVG": "FVG_FAMILY",
    "FVG_CE_MITIGATION": "FVG_FAMILY",
    "IFVG_RETEST_CONFLUENCE": "FVG_FAMILY",
    "MTF_SR_FVG_RECLAIM": "FVG_FAMILY",
    "AMD_FVG": "FVG_FAMILY",

    "FAILED_FVG_REVERSAL": "FAILED_FVG_FAMILY",
    "FAILED_BREAKOUT_REVERSAL": "FAILED_BREAKOUT_FAMILY",

    "BREAKER_BLOCK": "BREAKER_FAMILY",
    "ORDER_BLOCK": "ORDER_BLOCK_FAMILY",
    "OB_FVG_COMBO": "OB_FVG_FAMILY",
    "MTF_OB_ENTRY": "ORDER_BLOCK_FAMILY",

    "LIQUIDITY_SWEEP": "LIQUIDITY_FAMILY",
    "LIQUIDITY_TRAP": "LIQUIDITY_FAMILY",
    "LIQUIDITY_CANDLE": "LIQUIDITY_FAMILY",
    "MICRO_SR_SWEEP_RECLAIM": "LIQUIDITY_FAMILY",
    "STRUCTURE_LIQUIDITY": "LIQUIDITY_FAMILY",

    "WAVETREND_MOMENTUM": "MOMENTUM_FAMILY",
    "WAVETREND_PIVOT": "MOMENTUM_FAMILY",
    "RELIEF_RALLY": "MOMENTUM_FAMILY",
...
# =========================
# Pending Better Entry After Block
# =========================
ENABLE_PENDING_BETTER_ENTRY_AFTER_BLOCK = True

PENDING_BETTER_ENTRY_AFTER_BLOCK_REASONS = [
    "HIGH_SLIPPAGE",
    "LOW_RR",
]
...
PENDING_BETTER_ENTRY_MIN_SCORE = 98
PENDING_BETTER_ENTRY_MIN_RR = 0.95
PENDING_BETTER_ENTRY_RETRACE_PRICE = 1.0
PENDING_BETTER_ENTRY_EXPIRY_MINUTES = 15

PENDING_BETTER_ENTRY_SPLIT_ENABLED = True
PENDING_BETTER_ENTRY_FIRST_SPLIT_PCT = 0.50
PENDING_BETTER_ENTRY_SECOND_SPLIT_REQUIRE_M5_CLOSE = True
PENDING_BETTER_ENTRY_MIN_ORIGINAL_RR = 2.50

PENDING_BETTER_ENTRY_LOW_RR_TARGET_RR = 0.95

PENDING_BETTER_ENTRY_SECOND_SPLIT_ENABLED = True
PENDING_BETTER_ENTRY_SECOND_SPLIT_TIMEFRAME = mt5.TIMEFRAME_M5
PENDING_BETTER_ENTRY_SECOND_SPLIT_BARS = 80
PENDING_BETTER_ENTRY_SECOND_SPLIT_MIN_BODY_ATR = 0.10

# =========================
# Candidate Low-RR Parking
# =========================
ENABLE_CANDIDATE_LOW_RR_PARKING = True

CANDIDATE_LOW_RR_PARKING_MIN_SCORE = 98
CANDIDATE_LOW_RR_PARKING_MIN_ORIGINAL_RR = 0.40
CANDIDATE_LOW_RR_PARKING_MAX_RETRACE_PRICE = 5.0
