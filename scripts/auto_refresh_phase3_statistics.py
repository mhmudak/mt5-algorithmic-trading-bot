...
def refresh_statistics(account_dir, intel_dir):
    ...
    commands = [
        ...
        (
            "phase4_orderflow_gate_safety_tests",
            [python, str(ROOT / "scripts" / "test_phase4_orderflow_gate_safety.py")],
        ),
        (
            "phase4_orderflow_provider_readiness",
        ...
        (
            "phase4_mt5_proxy_context",
            [python, str(ROOT / "scripts" / "build_phase4_mt5_proxy_context.py")],
        ),
        (
            "phase4_mt5_proxy_context_history",
            [python, str(ROOT / "scripts" / "record_phase4_mt5_proxy_context_history.py")],
        ),
        (
            "phase4_mt5_proxy_context_change_detector",
