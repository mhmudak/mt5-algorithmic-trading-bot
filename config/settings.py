...
ENABLE_FCR_M1_FVG_INTRABAR_SHADOW = False
FCR_M1_FVG_INTRABAR_SHADOW_MIN_INTERVAL_SECONDS = 1.0
FCR_M1_FVG_INTRABAR_SHADOW_OUTPUT = "data/research/fcr_intrabar_shadow_observations.jsonl"
FCR_M1_FVG_INTRABAR_SHADOW_STATE = "data/research/fcr_intrabar_shadow_state.json"
...
# ============================================================
ENABLE_SETUP_HISTORICAL_OPTIMIZER = False
ENABLE_SETUP_HISTORICAL_OPTIMIZER_WALK_FORWARD_SNAPSHOTS = False

# ============================================================
# BETTER ENTRY OPTIMIZER V1
# OBSERVATION ONLY - NO EXECUTION AUTHORITY.
# ============================================================
ENABLE_BETTER_ENTRY_OPTIMIZER = False
ENABLE_BETTER_ENTRY_OPTIMIZER_COUNTERFACTUAL_TRACKER = False
...
BETTER_ENTRY_OPTIMIZER_MIN_HISTORICAL_SAMPLE = 20
BETTER_ENTRY_OPTIMIZER_HIGH_CONFIDENCE_SAMPLE = 50
SETUP_HISTORICAL_OPTIMIZER_MIN_SETUP_WIN_SAMPLE = 20
SETUP_HISTORICAL_OPTIMIZER_MIN_PATH_SAMPLE = 20
SETUP_HISTORICAL_OPTIMIZER_HIGH_CONFIDENCE_SAMPLE = 50
SETUP_HISTORICAL_OPTIMIZER_MIN_COVERAGE = 0.60
...
# =========================
ENABLE_AUTO_STRUCTURAL_LEVEL_SCALP = False
...
HRCM_ENABLE_EVENING_STAR = True
HRCM_ENABLE_MORNING_STAR = True
HRCM_STAR_MIN_FIRST_BODY_RATIO = 0.40
HRCM_STAR_MAX_MIDDLE_BODY_RATIO = 0.30
HRCM_STAR_REQUIRE_CLOSE_BEYOND_MIDPOINT = True


# =========================
# PHASE 6L - HTF INSIDE BAR FAKEOUT / MOTHER BAR TRAP
# =========================
ENABLE_HTF_INSIDE_BAR_FAKEOUT_MTF_ENTRY = True

IBF_HTF_AGGREGATION_BARS = 4          # 4 x M15 = H1 proxy
IBF_LOOKBACK_HTF_BARS = 24
IBF_EXTENSION_HTF_BARS = 3

IBF_REQUIRE_LOCATION = True
IBF_REQUIRE_EXTENSION = True
IBF_REQUIRE_MTF_CONFIRMATION = True
IBF_MTF_CONFIRMATION_BARS = 3

IBF_LEVEL_PROXIMITY_PRICE = 2.0
IBF_BREAK_BUFFER_PRICE = 0.30
IBF_CLOSE_BACK_INSIDE_BUFFER = 0.10
IBF_MIN_EXTENSION_PRICE = 3.0

IBF_INSIDE_BAR_MIN_CONTAINMENT = 0.05
IBF_MAX_INSIDE_RANGE_RATIO = 0.75
IBF_MIN_FAKEOUT_BODY_RATIO = 0.20

IBF_SL_BUFFER_PRICE = 0.60
IBF_TARGET_RR = 2.20
IBF_MIN_RR = 1.80
IBF_MIN_SCORE = 94
...
# =========================
# PHASE 6M - HTF DOUBLE TOP / DOUBLE BOTTOM NECKLINE BREAK-RETEST
# =========================
ENABLE_HTF_DOUBLE_TOP_BOTTOM_MTF_ENTRY = True

DTB_HTF_AGGREGATION_BARS = 4          # 4 x M15 = H1 proxy
DTB_LOOKBACK_HTF_BARS = 40
DTB_SWING_WINDOW = 1

DTB_MIN_SEPARATION_BARS = 2
DTB_MAX_SEPARATION_BARS = 16
DTB_PEAK_TOLERANCE_PRICE = 2.0
DTB_TROUGH_TOLERANCE_PRICE = 2.0
DTB_MIN_NECKLINE_DISTANCE = 4.0

DTB_BREAK_BUFFER_PRICE = 0.40
DTB_RETEST_TOLERANCE_PRICE = 1.50
DTB_CLOSE_BACK_BUFFER_PRICE = 0.10

DTB_REQUIRE_MTF_CONFIRMATION = True
DTB_MTF_CONFIRMATION_BARS = 3

DTB_MIN_RETEST_BODY_RATIO = 0.15
DTB_SL_BUFFER_PRICE = 0.70
DTB_TARGET_RR = 2.20
DTB_MIN_RR = 1.80
DTB_MIN_SCORE = 94
...
# =========================
# Phase 6V Tracked Setup Confirmation Gate
# =========================
ENABLE_TRACKED_SETUP_CONFIRMATION_GATE = True
TRACKED_SETUP_CONFIRMATION_GATE_MIN_CONFIDENCE = 50
TRACKED_SETUP_CONFIRMATION_GATE_MIN_SCORE_DELTA = -4
TRACKED_SETUP_CONFIRMATION_GATE_BLOCK_OPTIONAL_FAILED = True

# =========================
# Phase 6V2 Tracked Promotion + Low RR Wait
# =========================
ENABLE_MTF_CONFLICT_TRACK_ONLY_PROMOTION = True
MTF_CONFLICT_TRACK_ONLY_PROMOTION_MIN_SCORE = 95

ENABLE_MTF_CONFLICT_LOW_RR_WAIT_BETTER_ENTRY = True
MTF_CONFLICT_LOW_RR_WAIT_BETTER_ENTRY_EXPIRY_MINUTES = 15

ENABLE_REJECTED_CANDIDATE_LOW_RR_WAIT_BETTER_ENTRY = True
REJECTED_CANDIDATE_LOW_RR_WAIT_BETTER_ENTRY_EXPIRY_MINUTES = 15

# =========================
# Phase 6W Intrabar Opposite Direction Guard
# =========================
ENABLE_INTRABAR_OPPOSITE_ACTIVE_SETUP_GUARD = True
...
# =========================
# Phase 6W4 M15 Setup Direction Lock
# =========================
ENABLE_M15_SETUP_DIRECTION_LOCK = True
M15_SETUP_DIRECTION_LOCK_TTL_SECONDS = 900
