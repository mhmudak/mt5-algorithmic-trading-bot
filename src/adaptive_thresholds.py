...
from config.settings import (
    ...
    VWAP_RECLAIM_BASE_MIN_SCORE,
    BREAKER_BLOCK_BASE_MIN_SCORE,
    MTF_OB_ENTRY_BASE_MIN_SCORE,
    FCR_M1_FVG_BASE_MIN_SCORE,
    WAVETREND_PIVOT_BASE_MIN_SCORE,
    STRUCTURE_LIQUIDITY_BASE_MIN_SCORE,
    LVN_FVG_RECLAIM_BASE_MIN_SCORE,
    AMD_FVG_BASE_MIN_SCORE,
    FVG_CE_MITIGATION_BASE_MIN_SCORE,
    LIQUIDITY_POOL_OB_BASE_MIN_SCORE,
    FAILED_BREAKOUT_REVERSAL_BASE_MIN_SCORE,
    FAILED_FVG_REVERSAL_BASE_MIN_SCORE,
    HTF_FIB_CONFLUENCE_BASE_MIN_SCORE,
)
...
BASE_THRESHOLDS = {
    ...
    "VWAP_RECLAIM": VWAP_RECLAIM_BASE_MIN_SCORE,
    "BREAKER_BLOCK": BREAKER_BLOCK_BASE_MIN_SCORE,
    "MTF_OB_ENTRY": MTF_OB_ENTRY_BASE_MIN_SCORE,
    "FCR_M1_FVG": FCR_M1_FVG_BASE_MIN_SCORE,
    "WAVETREND_PIVOT": WAVETREND_PIVOT_BASE_MIN_SCORE,
    "STRUCTURE_LIQUIDITY": STRUCTURE_LIQUIDITY_BASE_MIN_SCORE,
    "LVN_FVG_RECLAIM": LVN_FVG_RECLAIM_BASE_MIN_SCORE,
    "AMD_FVG": AMD_FVG_BASE_MIN_SCORE,
    "FVG_CE_MITIGATION": FVG_CE_MITIGATION_BASE_MIN_SCORE,
    "LIQUIDITY_POOL_OB": LIQUIDITY_POOL_OB_BASE_MIN_SCORE,
    "FAILED_BREAKOUT_REVERSAL": FAILED_BREAKOUT_REVERSAL_BASE_MIN_SCORE,
    "FAILED_FVG_REVERSAL": FAILED_FVG_REVERSAL_BASE_MIN_SCORE,
    "HTF_FIB_CONFLUENCE": HTF_FIB_CONFLUENCE_BASE_MIN_SCORE,
}
