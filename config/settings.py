...
ENABLE_ORB_FAILED_RETEST_REVERSAL = True

ORB_FAILED_RETEST_REVERSAL_EXPIRY_MINUTES = 30
ORB_FAILED_RETEST_REVERSAL_RETRACE_PRICE = 3.0
ORB_FAILED_RETEST_REVERSAL_FIXED_SL_PRICE = 9.0
ORB_FAILED_RETEST_REVERSAL_FIXED_TP_PRICE = 9.0
ORB_FAILED_RETEST_REVERSAL_CONFIRMATION_TIMEFRAME = mt5.TIMEFRAME_M5
ORB_FAILED_RETEST_REVERSAL_MIN_SCORE = 98

ORB_FAILED_RETEST_REVERSAL_STRATEGIES = [
    "ORB",
    "ORB_V00",
]

# =========================
# ORB Failed Retest / SMC-Failed Opposite Scalp
# =========================
ENABLE_ORB_FAILED_RETEST_OPPOSITE_SCALP = True

ORB_FAILED_RETEST_OPPOSITE_SCALP_EXPIRY_MINUTES = 30
ORB_FAILED_RETEST_OPPOSITE_SCALP_MIN_SCORE = 98

# Retest zone logic
ORB_FAILED_RETEST_OPPOSITE_SCALP_ZONE_WIDTH_PRICE = 2.0
ORB_FAILED_RETEST_OPPOSITE_SCALP_TRIGGER_BUFFER_PRICE = 0.10
ORB_FAILED_RETEST_OPPOSITE_SCALP_SMC_MOVE_PRICE  = 3.0

# Opposite scalp risk model
ORB_FAILED_RETEST_OPPOSITE_SCALP_FIXED_SL_PRICE = 9.0
ORB_FAILED_RETEST_OPPOSITE_SCALP_FIXED_TP_PRICE = 9.0
ORB_FAILED_RETEST_OPPOSITE_SCALP_LOT_MULTIPLIER = 1.0

# Protection
ORB_FAILED_RETEST_OPPOSITE_SCALP_PROTECT_AFTER_PROFIT_PRICE = 5.0
ORB_FAILED_RETEST_OPPOSITE_SCALP_PROTECT_SL_TO_ENTRY = True

# Optional safety confirmation
ORB_FAILED_RETEST_OPPOSITE_SCALP_REQUIRE_M5_CONFIRMATION = True
ORB_FAILED_RETEST_OPPOSITE_SCALP_CONFIRMATION_TIMEFRAME = mt5.TIMEFRAME_M5
ORB_FAILED_RETEST_OPPOSITE_SCALP_CONFIRMATION_BARS = 80
ORB_FAILED_RETEST_OPPOSITE_SCALP_MIN_BODY_ATR = 0.10
ORB_FAILED_RETEST_OPPOSITE_SCALP_REQUIRE_EMA_ALIGNMENT = True
